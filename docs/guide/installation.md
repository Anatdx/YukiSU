...
> **Note:** These external kernels may still include susfs. YukiSU itself no longer supports susfs - we use built-in Kasumi instead.
...
> **Note:** The repository name still contains "SUSFS" but YukiSU uses Kasumi instead.
