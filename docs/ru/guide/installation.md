...
> **Примечание:** Эти внешние ядра могут всё еще включать susfs. Сам YukiSU больше не поддерживает susfs — вместо этого мы используем встроенный Kasumi.
...
> **Примечание:** Название репозитория всё еще содержит "SUSFS", но YukiSU использует Kasumi вместо этого.
