...
> **Примечание:** Эти внешние ядра могут всё еще включать SUSFS. YukiSU не включает SUSFS или бэкенд монтирования; при необходимости установите совместимый внешний MetaModule.
...
> **Примечание:** Название репозитория всё еще содержит "SUSFS", но YukiSU не включает SUSFS или бэкенд монтирования.
